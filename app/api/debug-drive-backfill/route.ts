// TEMPORARY debug route — re-uploads an existing QBO invoice's PDF to Drive
// with a fresh copy, to verify the drive.file -> drive scope fix actually
// places files inside the shared folder instead of My Drive. Updates
// drive_file_id to the new copy. DELETE after use; not meant to ship.
